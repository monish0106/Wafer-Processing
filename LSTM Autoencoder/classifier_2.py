...
print((train_object.data[0]).shape)
# print(train_object.data[:][0])
# print((train_object.num_examples))

lstm_autoencoder.basic_lstm_autoencoder(train_object,test_object,bs =train_object.num_examples, num_hidden = 16, time_steps = 297, n_inputs = 10, iteration = 1000,lr = 0.01)
# lstm.basic_lstm_technique(train_object,test_object,time_steps = 297, num_units = 32, n_input = 10, lr = 0.01,n_classes = 2,bs = train_object.num_examples)
